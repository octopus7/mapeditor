/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/api/wrangler.jsonc apps/api/worker-configuration.d.ts` (hash: ce6057a034fc8bdcea1cb6c41bdcdf3e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "GOOGLE_CLIENT_ID" | "SESSION_SECRET">> {}
}
