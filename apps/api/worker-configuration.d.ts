/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/api/wrangler.jsonc apps/api/worker-configuration.d.ts` (hash: 16ea37c5e94a55571c6edd681a007651)
// Runtime types generated with workerd@1.20260730.1 2026-08-02 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ALLOWED_ORIGINS: "https://mapedit.pages.dev,http://127.0.0.1:4173,http://localhost:4173";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "DEVELOPER_DEBUG_IPS" | "MEME_UPLOAD_BASE_URL" | "MEME_IMAGE_ORIGIN" | "GOOGLE_CLIENT_ID" | "SESSION_SECRET" | "MEME_UPLOAD_TOKEN">> {}
}
